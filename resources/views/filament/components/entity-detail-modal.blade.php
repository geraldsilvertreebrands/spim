@php
    ...
    $attributes = App\Models\Attribute::where('entity_type_id', $entityType->id)
...
<div class="space-y-6">
    @foreach($sections as $section)
        @if(isset($grouped[$section->id]) && $grouped[$section->id]->isNotEmpty())
            <div class="border border-gray-200 rounded-lg overflow-hidden">
                <div class="bg-gray-50 px-4 py-3 border-b border-gray-200">
                    <h3 class="text-lg font-semibold text-gray-900">{{ $section->name }}</h3>
                </div>
                <div class="bg-white">
                    @foreach($grouped[$section->id] as $attribute)
                        @php
                            try {
                        ...
                        <div class="flex items-start justify-between border-b border-gray-200 last:border-b-0 pb-3 hover:bg-gray-50 px-4 py-3">
    ...
    @if(isset($grouped['unsectioned']) && $grouped['unsectioned']->isNotEmpty())
        <div class="border border-gray-200 rounded-lg overflow-hidden">
            <div class="bg-gray-50 px-4 py-3 border-b border-gray-200">
                <h3 class="text-lg font-semibold text-gray-900">Other Attributes</h3>
            </div>
            <div class="bg-white">
